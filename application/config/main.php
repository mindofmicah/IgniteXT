...
if (isset($application_config['databases']))
{
	foreach ($application_config['databases'] as $id => $db_string)
	{
		...
		{
			case 6:	\System\Database::connect($id, $db_array[0], $db_array[1], $db_array[2], $db_array[3], $db_array[4]); break;
			case 4:	\System\Database::connect_dsn($id, $db_array[0], $db_array[1], $db_array[2]); break;
			case 3: \System\Database::connect_dsn($id, $db_array[0], $db_array[1]); break;
			case 2:	\System\Database::connect_dsn($id, $db_array[0]); break;
